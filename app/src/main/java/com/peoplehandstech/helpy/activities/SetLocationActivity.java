...
public class SetLocationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void goToSignUp (View view)
    {
        ...
        if(clicked)
        {
            com.peoplehandstech.helpy.models.Location loc=new com.peoplehandstech.helpy.models.Location(selectedLocation.getLatitude(),selectedLocation.getLongitude());
            i.putExtra("user location",loc);
           // i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP );

            setResult(SignUpActivity.RESULT_OK,i);
            finish();
        }
        //if not we will send the last known location
        else
        {
            com.peoplehandstech.helpy.models.Location loc=new com.peoplehandstech.helpy.models.Location(location.getLatitude(),location.getLongitude());
            i.putExtra("user location",loc);
           // i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP );
            setResult(SignUpActivity.RESULT_OK,i);
            finish();
